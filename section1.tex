...
Thanks to it, drivers or autonomous vehicles can achieve a broader view.
But deployment is hard, we cannot retire all current non-ITS vehicles at once.
...
Meanwhile, relay the CAMs sent from surrounding vehicles, when it could interfere the V2V communication.
